...
namespace Sep14Class
{
    ...
    public class Searching
    {
        ...
        {
            movies.Add(new Movie("Vikranth Rona", "Kannada", "Thriller", 20));
            movies.Add(new Movie("Warrior", "Telugu", "action", 50));
            movies.Add(new Movie("Brahmasthr", "Hindi", "Fantacy", 60));
            movies.Add(new Movie("Vikram", "Tamil", "Thriller", 40));    
            movies.Add(new Movie("Kurup", "Malyalam", "Thriller", 34));
        }
        public void search()
        {
            ...
            switch (p)
            {
                case 1:
                    ...
                    break;
                case 2:
                    Console.WriteLine("Enter movie language to search");
    ...
    public class CustomerUser : Searching
    {
        ...
        {
            if (Id == 9945772776 && Password == "08578751")
            {
                login = "true";
                return true;
            }
