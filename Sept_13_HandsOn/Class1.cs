...
namespace Sept13Class
{
    ...
    public class User : Movie
    {
        ...
        {
            Movie m = new Movie("Vikranth Rona", "Kannada", "Thriller", 20);
            dbmovies.Add(m);
            Movie k = new Movie("Warrior", "Telugu", "Action", 30);
            dbmovies.Add(k);
            Movie t = new Movie("Brahmasthr", "Hindi", "Fantasy", 30);
            dbmovies.Add(t);
            Movie n = new Movie("Vikram", "Tamil", "Thriller", 30);
            dbmovies.Add(n);
